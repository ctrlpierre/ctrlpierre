...
Passionné par l'informatique scientifique et le traitement du signal, je me dirige vers une carrière de recherche et de dévelopement dans le domaine de l'audio. Mon cursus me permet d'allier la rigueur des mathématiques à la puissance du développement logiciel.
...
* **[Synthèse Inverse Audio *(en cours)*](https://github.com/ctrlpierre/synth-param-inference)** : Conception d'un modèle pour inférer les paramètres d'un synthétiseur à partir d'un fichier audio source.
...
![Assembly](https://img.shields.io/badge/Assembly-555555?style=flat&logo=arm&logoColor=white)
